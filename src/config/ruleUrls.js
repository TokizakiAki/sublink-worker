...
export const SITE_RULE_SET_BASE_URL = 'https://cdn.jsdelivr.net/gh/lyc8503/sing-box-rules@rule-set-geosite/';
export const IP_RULE_SET_BASE_URL = 'https://cdn.jsdelivr.net/gh/lyc8503/sing-box-rules@rule-set-geoip/';
