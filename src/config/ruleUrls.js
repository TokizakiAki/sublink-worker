...
export const SITE_RULE_SET_BASE_URL = 'https://gh-proxy.com/https://github.com/lyc8503/sing-box-rules/tree/rule-set-geosite';
export const IP_RULE_SET_BASE_URL = 'https://gh-proxy.com/https://github.com/lyc8503/sing-box-rules/tree/rule-set-geoip';
